...
### Changed
- **Documentation**: Cleaned up the environment configuration table in README.md by removing emojis.
- **Author**: Updated author email in pyproject.toml to `joshid647@gmail.com` and simplified the "About the Author" section in README.
